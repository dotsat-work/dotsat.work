...
// By testing found that the net/mail package actually accepts user@domain (without a TLD).
// This is technically valid per RFC 5322 (e.g., for local network emails)
